...
//  What will braille learning look like in five years with iPhone and AI 
//integration? Describe how AI and mobile technology can improve braille education 
//and accessibility for blind and visually impaired users. (Max 50 words)
//"""

  @State private var prompt: String = """
  You are a teacher braille for a child of 8 years old.
  """
  @State private var message: String = """
  Write a fairy tale, 
  in the style of Hans Christian Anderson,
  about princes, prince and a frog, 
  Not more 100 words. Words length < 8. Sentence length < 10 words. 
  No capitals, no interpunction. 
  Dot is allowed. Lines under each other.
  """
...
//              apiKey: apiKey)
  ...
  func speak(_ text: String) {
    ...
    // Example: Use the Samantha voice (U.S. English) com.apple.ttsbundle.Samantha-compact
...
//    if let voice = AVSpeechSynthesisVoice(identifier: "com.apple.voice.compact.en-US.Samantha") {
      ...
      utterance.rate = 0.5 // Adjust for slower or faster speech
    } else {
